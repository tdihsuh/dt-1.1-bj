...
public class DeleteFromHBase {
  public static void delete(Configuration conf) throws IOException {
    ...
    delete.addColumn(Bytes.toBytes(TableInformation.FAMILY_NAME_ARTICLE), Bytes.toBytes(TableInformation.QUALIFIER_NAME_1_TAG));
//    delete.addColumn(Bytes.toBytes(TableInformation.FAMILY_NAME_ARTICLE), Bytes.toBytes(TableInformation.QUALIFIER_NAME_1_CONTENT), 1000000);
    table.delete(delete);
