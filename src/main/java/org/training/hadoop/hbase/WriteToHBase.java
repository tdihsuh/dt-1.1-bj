...
//      for (int i = 0; i < 1000; i++) {
      ...
      JSONObject valueJsonObject = JSONObject.fromObject("{'name':'lixinhu','gender':'man','age':12}");
      String name =(String) valueJsonObject.get("name1");

        int i = 3;
        Put put = new Put(Bytes.toBytes("row_lxh_01"));
